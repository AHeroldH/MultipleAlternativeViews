...
data = pd.read_csv('Experiments/Time/thread_time_2.csv')
...
ax.axhline(y=100, color='blue', label='$c$')
ax.axvline(x=2500, color='black', label='$n_0$', linestyle='dashed')
...
plt.savefig('multi_threads_complexity.png')
plt.show()
